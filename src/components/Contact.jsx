            ...
            <form className={`max-w-2xl mx-auto text-gray-600 pt-8`}>
                <div className={`flex flex-wrap`}>
                    <div className={`w-full md:w-1/2 text-left`}>
                        Your name
                        <input className={`w-full border border-gray-100 rounded py-3 px-4 mt-2`} type={`text`}
                    ...
                    <div className={`w-full md:w-1/2 text-left md:pl-4`}>
                        Your Email
                        <input className={`w-full border border-gray-100 rounded py-3 px-4 mt-2`} type={`email`}
